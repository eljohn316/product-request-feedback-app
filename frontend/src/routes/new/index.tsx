...
function RouteComponent() {
  return (
    <div className="px-6 py-[2.125rem] md:mx-auto md:max-w-[33.75rem] md:px-0 md:py-14">
      ...
      <div className="relative mt-[3.4375rem] rounded-[0.625rem] bg-white px-6 pt-11 pb-6 md:px-[2.625rem] md:pt-[3.25rem] md:pb-10">
        <img
          src={newFeedbackIcon}
        ...
        <div className="mb-6 md:mb-10">
          <h3 className="heading-3 text-east-bay md:heading-1">
            Create New Feedback
          </h3>
        </div>
        <NewFeedbackForm />
